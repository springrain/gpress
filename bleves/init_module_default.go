...
func initModuleDefault() (bool, error) {
	...
	// 初始化各个字段
	moduleDefaultId := model.IndexFieldStruct{
		ID:           util.FuncGenerateStringID(),
		IndexCode:    constant.INDEX_MODULE_DEFAULT_NAME,
		IndexName:    "模型数据",
		FieldCode:    "ID",
		FieldName:    "模型数据ID",
		FieldType:    3,
	...
	moduleDefaultTitle := model.IndexFieldStruct{
		ID:        util.FuncGenerateStringID(),
		IndexCode: constant.INDEX_MODULE_DEFAULT_NAME,
		IndexName: "模型数据",
		FieldCode: "Title",
	...
	moduleDefaultKeyWords := model.IndexFieldStruct{
		ID:        util.FuncGenerateStringID(),
		IndexCode: constant.INDEX_MODULE_DEFAULT_NAME,
		IndexName: "模型数据",
		FieldCode: "KeyWords",
	...
	moduleDefaultDescription := model.IndexFieldStruct{
		ID:        util.FuncGenerateStringID(),
		IndexCode: constant.INDEX_MODULE_DEFAULT_NAME,
		IndexName: "模型数据",
	...
	moduleDefaultPageURL := model.IndexFieldStruct{
		ID:           util.FuncGenerateStringID(),
		IndexCode:    constant.INDEX_MODULE_DEFAULT_NAME,
		IndexName:    "模型数据",
		FieldCode:    "PageURL",
	...
	moduleDefaultSubtitle := model.IndexFieldStruct{
		ID:        util.FuncGenerateStringID(),
		IndexCode: constant.INDEX_MODULE_DEFAULT_NAME,
		IndexName: "模型数据",
		FieldCode: "Subtitle",
	...
	moduleDefaultContent := model.IndexFieldStruct{
		ID:        util.FuncGenerateStringID(),
		IndexCode: constant.INDEX_MODULE_DEFAULT_NAME,
		IndexName: "模型数据",
		FieldCode: "Content",
	...
	moduleDefaultCreateTime := model.IndexFieldStruct{
		ID:           util.FuncGenerateStringID(),
		IndexCode:    constant.INDEX_MODULE_DEFAULT_NAME,
		IndexName:    "模型数据",
